...
class CustomListener extends Listener {
  ...
  async exec() {
    ...
    client.guilds.cache.forEach(async function (Guild) {
      ...
      let voiceChannels = Guild.channels.cache
      ...
      let textChannels = Guild.channels.cache
      ...
      if (
        logChannel &&
        logChannel.permissionsFor(Guild.me).has("SEND_MESSAGES")
      ) {
