...
const PromiseQueue = (module.exports.PromiseQueue = require.main.require(
  "./util/PromiseQueue"
));
...
module.exports.commandFormat = function (message, name) {
  ...
  if (!prefix && command.handler && command.handler.prefix) {
    prefix = command.handler.prefix.call
      ? command.handler.prefix(message)
...
let playThemeTone = (module.exports.playThemeTone = async function (
  channel,
  id,
  opts
) {
  ...
  let location =
    id == "default"
      ? config.voiceJoinLeave.tones.defaultJoinTone
      : soundMap[id];
...
const playSound = (module.exports.playSound = async function (
  channel,
  location,
  opts
) {
